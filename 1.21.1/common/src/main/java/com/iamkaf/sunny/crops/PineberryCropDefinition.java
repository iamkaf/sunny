...
public final class PineberryCropDefinition extends SunnyCropDefinition {
    private static final String ID = "pineberry";
    private static final String DISPLAY_NAME = "Pineberry";
    ...
    public PineberryCropDefinition() {

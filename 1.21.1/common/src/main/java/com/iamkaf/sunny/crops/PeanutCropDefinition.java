...
public final class PeanutCropDefinition extends SunnyCropDefinition {
    private static final String ID = "peanut";
    private static final String DISPLAY_NAME = "Peanut";
